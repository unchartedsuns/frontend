...
const GettingStarted = () => (
  <CenterPiece>
    ...
    <div>
      ...
      <br/>
      <p>
        Tip! Access to a lot of the key features of the profile page – like to your nations, corporations,
    ...
    <div>
      ...
      <ul>
        <li>
          US Timeline – Learn about the history of the ‘verse from mankind’s first trip to Mars to the
        ...
        <li>
          ...
          Than Light travel in the US Universe.
        </li>
        <li>
